<template name="graceCirProgress">
	<view>
		<view :style="{width:width+'px', height:width+'px'}" v-if="canvasId == 1">
			<canvas :style="{width:width+'px', height:width+'px'}"  canvas-id="graceCirProgress1"></canvas>
		</view>
		<view :style="{width:width+'px', height:width+'px'}" v-if="canvasId == 2">
			<canvas :style="{width:width+'px', height:width+'px'}"  canvas-id="graceCirProgress2"></canvas>
		</view>
		<view :style="{width:width+'px', height:width+'px'}" v-if="canvasId == 3">
			<canvas :style="{width:width+'px', height:width+'px'}"  canvas-id="graceCirProgress3"></canvas>
		</view>
	</view>
</template>
<script>
